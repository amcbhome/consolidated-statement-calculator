...
if st.button("Generate Consolidation Results"):
    ...
    # Hypothetical P+S assets for extraction
    p_assets = 500000
    s_assets = 200000
...
with st.expander("Inter-group Trading & Unrealized Profit (PUP)"):
    st.write("""
    **Inter-group Trading:** All intra-group sales and purchases must be eliminated in full because the group cannot trade with itself.
